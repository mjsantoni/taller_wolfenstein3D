...
see the [Advanced Google Test Guide](V1_6_AdvancedGuide.md).
...
in [AdvancedGuide](V1_6_AdvancedGuide.md). You must call this function before calling `RUN_ALL_TESTS()`, or the flags
...
some [samples](V1_6_Samples.md), or continue with
