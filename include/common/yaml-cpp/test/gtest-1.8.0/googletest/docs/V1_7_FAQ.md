...
[Primer](V1_7_Primer.md) and [AdvancedGuide](V1_7_AdvancedGuide.md), send it to googletestframework@googlegroups.com.
...
No. You can use a feature called [value-parameterized tests](V1_7_AdvancedGuide.md#Value_Parameterized_Tests) which lets
...
Have you read a
[warning](V1_7_Primer.md#important-note-for-visual-c-users) on the Google Test Primer page?
